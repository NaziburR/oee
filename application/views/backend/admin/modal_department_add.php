...
<html>
	...
	<div class="col-md-12">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/manage_department/create/' , array('class' => 'form-horizontal validate', 'enctype' => 'multipart/form-data'));?>
	
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Department ID</label>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="deptname" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="" >
						</div>
					</div>
